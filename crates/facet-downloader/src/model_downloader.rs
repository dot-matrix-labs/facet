...
/// # Example
/// ```no_run
/// use facet_downloader::model_downloader::download_model;
///
/// # tokio_test::block_on(async {
/// download_model("microsoft/DialoGPT-medium", "~/.facet/models", None, false, true).await.unwrap();
/// # });
/// ```
...
/// Uses ~/.facet/models/cache instead of the standard HuggingFace cache
fn get_hf_cache_dir() -> Result<PathBuf> {
    ...
    // Use Robert-specific cache directory: ~/.facet/models/cache
    if let Ok(home) = env::var("HOME") {
